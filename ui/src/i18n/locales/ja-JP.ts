...
export const ja_JP: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint:
        "中央揃えのトランスクリプトに使用する任意の CSS 幅（例: 960px、82%、min(1280px, 82%)）。",
      messageWidthInvalid:
  ...
  connection: {
    queuedCount: "{count} 件がキューに追加されました",
    reconnecting: "再接続中…",
    retryNow: "今すぐ再試行",
    access: {
      title: "Gatewayへのアクセス",
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "このブラウザは更新後、一度限りのデバイス承認が必要です。",
      action: "このブラウザを保護",
      secureContextRequired:
        "このレガシーブラウザは一時的に利用可能です。HTTPS または localhost で再度開いて、デバイスIDで保護してください。",
      pendingUnavailable:
  ...
  chat: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "スレッドの所有者とメンバーのみがこのスレッドで操作できます。",
    },
    sessionSuggestions: {
      suggest: "提案",
