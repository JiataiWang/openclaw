...
export const uk: TranslationMap = {
  ...
  newSession: {
    ...
    incognito: "Інкогніто",
    incognitoDescription: "Зберігати цей тред лише до перезапуску Gateway",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      llamaCppHint: "Завантажте локальну модель розміром приблизно 5.0 ГБ; потрібно 16 ГБ RAM",
    },
    manual: {
  ...
  login: {
    ...
    deviceAuthMigration: {
      banner: "Цьому браузеру після оновлення потрібне одноразове підтвердження пристрою.",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "Гілку потоку змінено — перегляньте та надішліть повторно.",
    },
    waitingForApproval: "Очікування схвалення…",
    startupStatus: {
