...
export const pl: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint:
        "Opcjonalna szerokość CSS dla wyśrodkowanej transkrypcji, np. 960px, 82% lub min(1280px, 82%).",
      messageWidthInvalid:
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      button: "Konfiguruj / Pobierz model",
      ollamaLabel: "Ollama",
    ...
    wizard: {
      ...
      prepareStarting: "Uruchamianie konfiguracji lokalnego modelu…",
  ...
  chat: {
    ...
    sessionSharing: {
      ...
      readOnlyNotice: "Tylko właściciel wątku i jego członkowie mogą w nim działać.",
    },
    sessionSuggestions: {
      suggest: "Zaproponuj",
      suggestMessage: "Zaproponuj wiadomość",
      attachmentsUnsupported: "Usuń załączniki przed przesłaniem sugestii tekstowej.",
      sendNow: "Wyślij teraz sugestię od {author}",
      queue: "Dodaj do kolejki sugestię od {author}",
      edit: "Edytuj sugestię od {author}",
      dismiss: "Odrzuć sugestię od {author}",
      typing: "{name} pisze…",
