...
export const nl: TranslationMap = {
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      ollamaLabel: "Ollama",
      ollamaHint: "Download een tools-compatibel model van je Ollama-server",
    ...
    wizard: {
      ...
      prepareStarting: "Lokale modelconfiguratie starten…",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "De thread is van vertakking gewisseld — bekijk en verstuur opnieuw.",
    },
