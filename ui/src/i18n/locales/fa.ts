...
export const fa: TranslationMap = {
  ...
  configView: {
    ...
    chatPrefs: {
      ...
      messageWidthHint: "عرض اختیاری CSS برای رونوشت وسط‌چین، مانند 960px، 82% یا min(1280px, 82%).",
      messageWidthInvalid:
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      ollamaLabel: "Ollama",
      ollamaHint: "یک مدل با قابلیت ابزار را از سرور Ollama خود دانلود کنید",
      llamaCppLabel: "مدل محلی (llama.cpp)",
      llamaCppHint: "یک مدل محلی حدوداً ۵.۰ گیگابایتی دانلود کنید؛ به ۱۶ گیگابایت RAM نیاز دارد",
    },
    manual: {
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      secureContextRequired:
        "این مرورگر قدیمی به‌طور موقت در دسترس می‌ماند. آن را روی HTTPS یا localhost دوباره باز کنید تا با هویت دستگاه ایمن شود.",
      pendingUnavailable: "درخواست جفت‌سازی مرورگر هنوز در دسترس نیست. لحظه‌ای دیگر دوباره تلاش کنید.",
      loadFailed: "درخواست جفت‌سازی این مرورگر بارگذاری نشد: {error}",
  ...
  chat: {
    ...
    sendErrors: {
      activeLeafChanged: "رشته شاخه‌ها را عوض کرد — بررسی و دوباره ارسال کنید.",
    },
    waitingForApproval: "در انتظار تأیید…",
    startupStatus: {
