...
export const de: TranslationMap = {
  ...
  modelSetup: {
    ...
    prepare: {
      title: "Ein lokales Modell einrichten",
      intro: "Lade ein lokales Modell auf diesem Gateway herunter oder bereite es vor.",
      ...
      llamaCppHint: "Lade ein lokales Modell mit etwa 5,0 GB herunter; erfordert 16 GB RAM",
    },
    manual: {
  ...
  chat: {
    ...
    sessionSuggestions: {
      ...
      typingMany: "{names} schreiben gerade…",
      state: {
        pending: "Ausstehend",
        accepted: "Akzeptiert",
        dismissed: "Verworfen",
