...
export const id: TranslationMap = {
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      llamaCppHint: "Unduh model lokal sekitar 5,0 GB; memerlukan RAM 16 GB",
    },
    manual: {
  ...
  login: {
    ...
    deviceAuthMigration: {
      ...
      pendingUnavailable: "Permintaan pemasangan browser belum tersedia. Coba lagi sebentar lagi.",
